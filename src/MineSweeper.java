public interface MineSweeper {
	/**
	 * * Initialises the field * * A mine-field of N x M squares is represented
	 * by N lines of exactly M characters each. * The character '*' represents a
	 * mine * and the character '.' represents no-mine. * Lines are separated by
	 * '\n' *
	 * <p/>
	 ...
	 * 
	 * @param mineField
	 *            string containing the mines * @throws IllegalArgumentException
	 ...
	 * * @return a string representation of the hint-field * @throws
	 * IllegalStateException if the mine-field has not been initialised (i.e.
